...
let nameSongs = [
	...
	"SIN TI", /*9*/
	"MI CHICA IDEAL", /*10*/
	"LO QUE NO SABES TÚ", /*11*/
	"REGÁLAME UN MUÑECO", /*12*/
	"ANDAS EN MI CABEZA", /*13*/
	"SE APAGÓ LA LLAMA", /*14*/
	"DEVUÉLVEME EL AMOR", /*15*/
	"SIMPLEMENTE TE QUIERO", /*16*/
	"TÚ ME QUEMAS", /*17*/
		"SE ACABÓ", /*18*/
	"TARTAMUDO", /*19*/
	"CHICA IDEAL", /*20*/
